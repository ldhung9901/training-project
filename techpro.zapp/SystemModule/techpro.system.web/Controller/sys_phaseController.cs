...
{
    public partial class sys_phaseController : BaseAuthenticationController
    {
        private sys_phase_repo repo;

        public sys_phaseController(IUserService UserService,techproDefautContext context) : base(UserService)
        {
            repo = new sys_phase_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_phases
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_phase_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<sys_phase_model> result = new DTResult<sys_phase_model>
                {
