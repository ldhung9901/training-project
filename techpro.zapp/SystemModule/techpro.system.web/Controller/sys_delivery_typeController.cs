...
{
    public partial class sys_delivery_typeController : BaseAuthenticationController
    {
        public sys_delivery_type_repo repo;

        public sys_delivery_typeController(IUserService UserService, techproDefautContext context) : base(UserService)
        {
            repo = new sys_delivery_type_repo(context);
        }
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_delivery_type_model>(json.GetValue("data").ToString());
        ...
        {
            var result = repo._context.sys_delivery_types.
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<sys_delivery_type_model> result = new DTResult<sys_delivery_type_model>
                {
