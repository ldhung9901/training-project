...
{
    public partial class sys_inventory_position_item_capacityController : BaseAuthenticationController
    {
        private sys_inventory_position_item_capacity_repo repo;

        public sys_inventory_position_item_capacityController(IUserService UserService, techproDefautContext context) : base(UserService)
        {
            repo = new sys_inventory_position_item_capacity_repo(context);
        }
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_inventory_position_item_capacity_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                var id_warehouse = dictionary["id_warehouse"];
                var id_position = dictionary["id_position"];
                var search = dictionary["search"];
                var query = repo.FindAll()
                    .Where(d => d.db.id_warehouse == id_warehouse)
                    .Where(d=>d.db.id_position == id_position)
                ...
                DTResult<sys_inventory_position_item_capacity_model> result = new DTResult<sys_inventory_position_item_capacity_model>
                {
