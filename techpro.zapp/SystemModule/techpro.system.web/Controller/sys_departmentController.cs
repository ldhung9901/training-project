...
{
    public partial class sys_departmentController : BaseAuthenticationController
    {
        public sys_department_repo repo;

        public sys_departmentController(IUserService UserService, techproDefautContext context) : base(UserService)
        {
            repo = new sys_department_repo(context);
        }

        public IActionResult getListUse()
        {
            var result = repo._context.sys_departments
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_department_model>(json.GetValue("data").ToString());
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<sys_department_model> result = new DTResult<sys_department_model>
                {
