...
{
    public partial class sys_item_typeController : BaseAuthenticationController
    {
        public sys_item_type_repo repo;

        public sys_item_typeController(IUserService UserService, techproDefautContext context) : base(UserService)
        {
            repo = new sys_item_type_repo(context);
        }
        ...
        public async Task<IActionResult> create([FromBody] JObject json)
        {
            ...
            var model = JsonConvert.DeserializeObject<sys_item_type_model>(json.GetValue("data").ToString());
        ...
        {
            var result = repo._context.sys_item_types.
                 Select(d => new
                 {
                     id = d.id,
                     name = d.name
        ...
        public async Task<IActionResult> DataHandler([FromBody] JObject json)
        {
            try
            {
                ...
                DTResult<sys_item_type_model> result = new DTResult<sys_item_type_model>
                {
