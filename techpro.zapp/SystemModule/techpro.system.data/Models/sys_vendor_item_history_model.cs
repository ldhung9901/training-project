...
{
    public  class sys_vendor_item_history_model
    { 
        public sys_vendor_item_history_model()
        {
            db = new sys_vendor_item_history_db();
        }
        ...
        public sys_vendor_item_history_db db { get; set; }
    }
}
