...
export class ShortcutsComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        let shortcut:Shortcut[]=[{
            id: "1",
            label:this._translocoService.translate('activity_history'),
            //description?: this._translocoService.translate('activity_history');
            icon       : 'heroicons_outline:clipboard-list',
            link       : '/sys_mongodb_user_auth_log_index',
            useRouter: true,
        },
        {
            id         : '2',
            label      : this._translocoService.translate('documentation'),
           // description: 'Getting started',
            icon       : 'heroicons_outline:book-open',
            link       : '/sys_version_history_index',
            useRouter  : true
        }
    ];
