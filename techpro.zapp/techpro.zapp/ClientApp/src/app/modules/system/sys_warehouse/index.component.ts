...
import { sys_warehouse_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_warehouse_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_warehouse_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, fuseConfirmationService, route, dialog, 'sys_warehouse',
            { search: "", status_del: "1" }
        )
    ...
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_warehouse_popUpAddComponent, {
            disableClose: true,
            data: {
                actionEnum: 1,
                db: {
    ...
    generateExcel() {
        ...
        writeXlsxFile(this.listData, {
            ...
            fileName: this._translocoService.translate('NAV.sys_warehouse')
        })
    }
