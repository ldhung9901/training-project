...
import { sys_job_title_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_job_title_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_job_title_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, fuseConfirmationService, route, dialog, 'sys_job_title',
            { search: "", status_del: "1" }
        )
    ...
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_job_title_popUpAddComponent, {
            disableClose: true,
            data: {
                actionEnum: 1,
                db: {
    ...
    generateExcel() {
        ...
        writeXlsxFile(this.listData, {
            ...
            fileName: this._translocoService.translate('NAV.sys_job_title')
        })
    }
