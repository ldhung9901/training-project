...
import { sys_delivery_type_popUpAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_delivery_type_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss']
})

export class sys_delivery_type_indexComponent extends BaseIndexDatatableComponent
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        super(http, baseUrl, _translocoService, fuseConfirmationService, route, dialog,'sys_delivery_type',
            { search: "", status_del: "1" }
        )
    ...
    openDialogAdd(): void {
        const dialogRef = this.dialog.open(sys_delivery_type_popUpAddComponent, {
            disableClose: true,
            data: {
                actionEnum: 1,
                db: {
    ...
    generateExcel() {
        ...
        writeXlsxFile(this.listData, {
            ...
            fileName: this._translocoService.translate('NAV.sys_delivery_type')
        })
    }
