...
@Component({
    selector: 'sys_help_detail_popupAdd',
    templateUrl: 'popupAdd.html',
})
export class sys_help_detail_popUpAddComponent extends BasePopUpAddComponent {
    public plugintiny = [
    ...
    constructor(public dialogRef: MatDialogRef<sys_help_detail_popUpAddComponent>,
