import { Component, EventEmitter, Input, OnDestroy, OnInit, Output, TemplateRef, ViewChild, ViewContainerRef, ViewEncapsulation } from '@angular/core';
...
export class CalendarSidebarComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._calendarService.calendars$
            ...
            .subscribe((calendars) => {
                if(this.showReschedule==false){
                    this.calendars=calendars.filter(t=>t.id!="changed");
                }else {
